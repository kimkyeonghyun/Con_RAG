...
class ArgParser():
    def __init__(self):
        ...
        self.parser.add_argument('--data_path', type = str, default = f'./dataset/{self.proj_name}',
        ...
        self.parser.add_argument('--model_type', type = str, choices = model_type_list, default = 't5-small',
                                 help = 'Type of the classification model to use.')
        self.parser.add_argument('--llm_model', type = str, default = 'llama2_chat',
                                 help = 'Type of the LLM model to use.')
